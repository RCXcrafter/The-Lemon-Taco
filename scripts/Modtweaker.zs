...
mods.avaritia.ExtremeCrafting.addShapeless(<Avaritia:Resource:5>,[<eternalsingularity:eternal_singularity>,<Avaritia:Ultimate_Stew>,<Avaritia:Cosmic_Meatballs>,<Avaritia:Endest_Pearl>,<Avaritia:Resource:7>,<ore:blockManyullyn>,<ore:blockSteel>,<ore:blockDragoonyte>,<ExtraUtilities:block_bedrockium>,<ore:blockTartarite>,<ore:blockSanguinite>,<ore:blockDesichalkos>,<ore:blockNeptunium>,<ore:ingotTooth>,<ephys.playerproxies:item.PP_DragonScaleIngot>,<ore:gemUnobtaniumHyperDiamond>,<erebus:materials:65>,<chancecubes:Compact_Giant_Chance_Cube>,<withercrumbs:Crumb_Star>,<TConstruct:heartCanister:6>,<Torcherino:tile.double_compressed_torcherino>,<metallurgycm:abstractor:9>,<metallurgycm:smelter:7>,<erebus:tarantulaEgg>,<erebus:antlionEgg>,<customitems:dinosaur>]);
